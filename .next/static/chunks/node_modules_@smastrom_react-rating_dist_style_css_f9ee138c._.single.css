/* [project]/node_modules/@smastrom/react-rating/dist/style.css [app-client] (css) */
.rr--group {
  width: 100%;
  display: flex;
  position: relative;
...
.rr--svg-stop-1 {
  stop-color: var(--rr--fill-on-color, #0000);
}

[dir="rtl"] .rr--svg-stop-1, .rr--svg-stop-2 {
  stop-color: var(--rr--fill-off-color, #0000);
}
...
/*# sourceMappingURL=node_modules_%40smastrom_react-rating_dist_style_css_f9ee138c._.single.css.map*/